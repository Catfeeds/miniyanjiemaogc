...
<script type="text/javascript" src="/minijunxishanhgnz/Public/ht/plugins/xheditor/xheditor-1.2.1.min.js"></script>
<script type="text/javascript" src="/minijunxishanhgnz/Public/ht/plugins/xheditor/xheditor_lang/zh-cn.js"></script>
</head>
<body>
    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
         ...
         <li data-index="0">
            ...
            <!-- <iframe class="pro_2" src="/minijunxishanhgnz/Data/inc/photo_add.php?id=photo_sj0&width=200&height=200" frameborder="0"></iframe> -->
              <?php if ($cate_info['bz_1']) { ?>
                <img src="/minijunxishanhgnz/Data/<?php echo $cate_info['bz_1']; ?>" width="200" height="200" />
              <?php } ?>
