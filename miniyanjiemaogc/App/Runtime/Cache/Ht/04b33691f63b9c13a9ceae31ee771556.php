          ...
          <div class="d1">缩略图:</div>
           <div>
            <?php if ($pro_allinfo['photo_x']) { ?>
                  <img src="/minijunxishanhgnz/Data/<?php echo $pro_allinfo['photo_x']; ?>" width="80" height="80" style="margin-bottom: 3px;" />
                  <br />
              <?php } ?>
          ...
          <div class="d1">大 图:</div>
           <div>
            <?php if ($pro_allinfo['photo_d']) { ?>
                  <img src="/minijunxishanhgnz/Data/<?php echo $pro_allinfo['photo_d']; ?>" width="125" height="125" style="margin-bottom: 3px;" />
                <br />
              <?php } ?>
          ...
          <?php foreach ($img_str as $v) { ?>
           <div>
            <div class="img-err" title="删除" onclick="del_img('<?php echo $v; ?>',this);">×</div>
             ...
             <?php }else{ ?>
              <img src="<?php echo '/minijunxishanhgnz/Data/'.$v; ?>" width="125" height="125">
             <?php } ?>
           </div>
          <?php } ?>
         </li>
...
<script type="text/javascript" src="/minijunxishanhgnz/Public/ht/js/product.js"></script>
<script>
function upadd(obj){
  //alert('aaa');
