...
class SearchController extends PublicController {
    ...
    public function searches(){
        ...
        $prolist = M('product')->where('del=0 AND pro_type=1 AND is_down=0 AND name LIKE "%'.$keyword.'%"')->order('addtime desc')->field('id,name,photo_x,shiyong,price,price_yh')->limit($page.',10')->select();
